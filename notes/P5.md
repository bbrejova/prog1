...
Ak program dáva zlé výsledky, "cyklí sa" alebo "padá"
  ...
  - Môžete skúsiť program znovu prečítať, či nezbadáte chybu.
      - Pomáha [dobrá čitateľnosť
        programov](./Prednáška_3#.C3.9Aprava_a_.C4.8Ditate.C4.BEnos.C5.A5_programov.md).
...
![Výsledný obrázok](P5-svgdraw.png "Výsledný obrázok")
  ...
  - Knižnicu si stiahnite a nainštalujte [podľa
    návodu](./Zimný_semester,_softvér#Pr.C3.A1ca_v_Kate_s_grafickou_kni.C5.BEnicou_SVGdraw.md)
...
![P5-kruhy.png](P5-kruhy.png "P5-kruhy.png") Nasledujúci program náhodne
